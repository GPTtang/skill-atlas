...
name: debug-pro
description: >
  Systematic debugging methodology with language-specific debugging commands and common error pattern reference.
  Use when debugging code, investigating errors, tracing bugs, or diagnosing system issues across JavaScript,
  TypeScript, Python, Swift, CSS, and network layers. Keywords: debug, fix bug, error, crash, trace, diagnose,
