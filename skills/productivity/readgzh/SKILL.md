...
name: readgzh
description: >
  Let AI read full-text WeChat Official Account articles via ReadGZH service.
  Supports standard articles and image-post formats. Use when user shares a
  mp.weixin.qq.com link, asks to read/summarize a WeChat article, or mentions
  "公众号", "微信文章", "gongzhonghao", "weixin article".
---
